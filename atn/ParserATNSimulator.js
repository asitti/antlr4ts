...
var ParserATNSimulator = /** @class */ (function (_super) {
    ...
    ParserATNSimulator.prototype.handleNoViableAlt = function (input, startIndex, previous) {
        if (previous.s0 != null) {
            var alts = new BitSet();
            var maxAlt = 0;
            for (var _i = 0, _a = Array.from(asIterable(previous.s0.configs)); _i < _a.length; _i++) {
                var config = _a[_i];
            ...
            switch (alts.cardinality()) {
                ...
                default:
                    ...
                    for (var _b = 0, _c = Array.from(asIterable(previous.s0.configs)); _b < _c.length; _b++) {
                        var config = _c[_b];
                        if (config.reachesIntoOuterContext || config.state instanceof RuleStopState) {
    ...
    ParserATNSimulator.prototype.applyPrecedenceFilter = function (configs, globalContext, contextCache) {
        ...
        for (var _b = 0, _c = Array.from(asIterable(configs)); _b < _c.length; _b++) {
            var config = _c[_b];
            if (config.alt === 1) {
                // already handled
                continue;
    ...
    ParserATNSimulator.prototype.closure = function (sourceConfigs, configs, collectPredicates, hasMoreContext, contextCache, treatEofAsEpsilon) {
        ...
        while (currentConfigs.size > 0) {
            ...
            for (var _i = 0, _a = Array.from(asIterable(currentConfigs)); _i < _a.length; _i++) {
                var config = _a[_i];
    ...
    ParserATNSimulator.prototype.dumpDeadEndConfigs = function (nvae) {
        ...
        for (var _i = 0, _a = Array.from(asIterable(deadEndConfigs)); _i < _a.length; _i++) {
            var c = _a[_i];
            var trans = "no edges";
